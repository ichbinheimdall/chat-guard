...
client.on('message', async message => {
    ...
    if (command.toLowerCase() === "sunucu-ayrıl") {
        if(config.BotOwners.includes(message.member.id) === false ) return message.channel.send(`<a:red:990277321414045767> Bu komut yalnızca geliştiricime özeldir.`);
...
<a:hologram:990277266892263475> **${moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]")}** dir aktifim.
    ...
    if(command.toLowerCase() === 'serverstatus') {
        ...
        message.channel.send(new MessageEmbed()
            ...
            .setTimestamp()
            .setDescription(`
<:space:990276555131465729> <a:settings:990276448185106512> Artık bu komut tamamen Türkçe!
<:arrow:990277284281872424> Yeni kullanım: \`${config.Prefix}sunucudurumu\`
    ...
    if(command.toLowerCase() === 'spamguard') {
        ...
        message.channel.send(new MessageEmbed()
            ...
            .setDescription(`
<:space:990276555131465729> <a:settings:990276448185106512> Artık bu komut tamamen Türkçe!
<:arrow:990277284281872424> Yeni kullanım: \`${config.Prefix}spamkoruma\`
    ...
    if(command.toLowerCase() === 'badwordguard') {
        ...
        message.channel.send(new MessageEmbed()
            ...
            .setDescription(`
<:space:990276555131465729> <a:settings:990276448185106512> Artık bu komut tamamen Türkçe!
<:arrow:990277284281872424> Yeni kullanım: \`${config.Prefix}küfürkoruma\`
    ...
    if(command.toLowerCase() === 'characterlimit') {
        ...
        message.channel.send(new MessageEmbed()
            ...
            .setDescription(`
<:space:990276555131465729> <a:settings:990276448185106512> Artık bu komut tamamen Türkçe!
<:arrow:990277284281872424> Yeni kullanım: \`${config.Prefix}karakterlimit\`
    ...
    if(command.toLowerCase() === 'masspingguard') {
        ...
        message.channel.send(new MessageEmbed()
            ...
            .setDescription(`
<:space:990276555131465729> <a:settings:990276448185106512> Artık bu komut tamamen Türkçe!
<:arrow:990277284281872424> Yeni kullanım: \`${config.Prefix}çokluetiket\`
    ...
    if(command.toLowerCase() === 'linkguard') {
        ...
        message.channel.send(new MessageEmbed()
            ...
            .setDescription(`
<:space:990276555131465729> <a:settings:990276448185106512> Artık bu komut tamamen Türkçe!
<:arrow:990277284281872424> Yeni kullanım: \`${config.Prefix}linkkoruma\`
    ...
    if(command.toLowerCase() === 'whitelist') {
        ...
        message.channel.send(new MessageEmbed()
            ...
            .setDescription(`
<:space:990276555131465729> <a:settings:990276448185106512> Artık bu komut tamamen Türkçe!
<:arrow:990277284281872424> Yeni kullanım: \`${config.Prefix}beyazliste\`
    ...
    if(command.toLowerCase() === 'muterole') {
        ...
        message.channel.send(new MessageEmbed()
            ...
            .setDescription(`
<:space:990276555131465729> <a:settings:990276448185106512> Artık bu komut tamamen Türkçe!
<:arrow:990277284281872424> Yeni kullanım: \`${config.Prefix}muterolü\`
    ...
    if(command.toLowerCase() === 'logchannel') {
        ...
        message.channel.send(new MessageEmbed()
            ...
            .setDescription(`
<:space:990276555131465729> <a:settings:990276448185106512> Artık bu komut tamamen Türkçe!
<:arrow:990277284281872424> Yeni kullanım: \`${config.Prefix}logkanalı\`
    ...
    if(command.toLowerCase() === 'inviteguard') {
        ...
        message.channel.send(new MessageEmbed()
            ...
            .setDescription(`
<:space:990276555131465729> <a:settings:990276448185106512> Artık bu komut tamamen Türkçe!
<:arrow:990277284281872424> Yeni kullanım: \`${config.Prefix}davetkoruma\`
...
<:arrow:990277284281872424> **Mute Rolü**: ${Database.MutedRoleID ? "<@&"+Database.MutedRoleID+">" : 'Mute Rolü ayarlanmamış.'}
...
<a:hologram:990277266892263475> Komutları ve kullanımlarını görmek için \`${config.Prefix}komutlar\` yazabilirsin.
<a:hologram:990277266892263475> Botu sunucuna eklemek/davet etmek için \`${config.Prefix}davet\` yazabilirsin.
<a:hologram:990277266892263475> Destek sunucusuna katılmak için \`${config.Prefix}destek\` yazabilirsin.
<a:hologram:990277266892263475> Bot top.gg üzerinden oy verip destek olmak için \`${config.Prefix}oy\` yazabilirsin. 
  `)).catch(() => {}); }
...
`)).catch(() => {}); }
    ...
    if(command.toLowerCase() === 'komutlar') {
        message.channel.send(new MessageEmbed()
            ...
            .setTimestamp()
            .setDescription(`
<a:100:990276334435586058> Yardım için \`${config.Prefix}yardım\` yazabilirsin.
<a:100:990276334435586058> Sunucunun durumunu görmek için: \`${config.Prefix}sunucudurumu\`

<:space:990276555131465729> <a:settings:990276448185106512> **Ayarlamalar:**
<:arrow:990277284281872424> Beyaz liste için: \`${config.Prefix}beyazliste [ekle/kaldır] [Rol/kanal/üye](etiket/id)\`
<:arrow:990277284281872424> Filtre için: \`${config.Prefix}filtre [ekle/kaldır] [kelime]\`
<:arrow:990277284281872424> Mute rolünü ayarlamak için: \`${config.Prefix}muterolü @rol [etiket/id] \`
<:arrow:990277284281872424> Mute süresini ayarlamak için: \`${config.Prefix}mutesüre 10 [Süreyi dakika cinsinden girin] \`
<:arrow:990277284281872424> Log kanalını ayarlamak için: \`${config.Prefix}logkanalı #kanal [etiket/id\`

<:space:990276555131465729> <a:settings:990276448185106512> **Korumalar:**
<:arrow:990277284281872424> Ceza kaldırmak için: \`${config.Prefix}cezakaldır @kullanıcı [etiket/id] \`  
<:arrow:990277284281872424> Uzun yazı engel için: \`${config.Prefix}karakterlimit [aç/kapat] \`
<:arrow:990277284281872424> Sunucu davet linki engel: \`${config.Prefix}davetkoruma [aç/kapat] \`
<:arrow:990277284281872424> Link engel için: \`${config.Prefix}linkkoruma [aç/kapat] \`
<:arrow:990277284281872424> Çoklu etiket engel için: \`${config.Prefix}çokluetiket [aç/kapat] \`
<:arrow:990277284281872424> Küfür engel için: \`${config.Prefix}küfürkoruma [aç/kapat] \`
<:arrow:990277284281872424> Spam engel için: \`${config.Prefix}spamkoruma [aç/kapat] \`
...
<a:hologram:990277266892263475> Bot top.gg üzerinden oy verip destek olmak için \`${config.Prefix}oy\` yazabilirsin. 
    ...
    if(command.toLowerCase() === 'yardım') {
        message.channel.send(new MessageEmbed()
            ...
            .setTimestamp()
            .setDescription(`
<a:100:990276334435586058> Komutlar için \`${config.Prefix}komutlar\` yazabilirsin.
<a:100:990276334435586058> Sunucunun durumunu görmek için: \`${config.Prefix}sunucudurumu\`
...
<a:hologram:990277266892263475> Bot top.gg üzerinden oy verip destek olmak için \`${config.Prefix}oy\` yazabilirsin. 
    ...
    if(command.toLowerCase() === 'beyazliste') {
        ...
        if(!args[0]) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: **'+config.Prefix+'beyazliste ekle/kaldır id/etiket (rol/kanal/kullanıcı)**'));
        ...
        if (args[0] === 'ekle' || args[0] === 'add' ) {
            ...
            if(!member && !role && !channel) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: **'+config.Prefix+'beyazliste ekle/kaldır id/etiket (rol/kanal/kullanıcı)**')).catch(() => {});
            ...
            if(member){   
                ...
                return message.channel.send(embed.setDescription('<:check:990277303579836468> **<@'+member.user.id+'>**, İsimli üye başarıyla beyaliste\'ye eklendi'));}
            ...
            if(role) { 
                ...
                return message.channel.send(embed.setDescription('<:check:990277303579836468> **<@&'+role.id+'>**, İsimli rol başarıyla beyaliste\'ye eklendi'));}
            ...
            if(channel) { 
                ...
                return message.channel.send(embed.setDescription('<:check:990277303579836468> **<#'+channel.id+'>**, İsimli kanal başarıyla beyazliste\'ye eklendi')).catch(() => {});}
        }
        if (args[0] === 'remove' || args[0] === 'kaldır' ) {
            ...
            var role = message.mentions.roles.first() || message.guild.roles.cache.get(args[1]);
            var channel = message.mentions.channels.first() || message.guild.channels.cache.get(args[1]);
            if(!member && !role && !channel) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: **'+config.Prefix+'beyaliste ekle/kaldır id/etiket (rol/kanal/kullanıcı)**')).catch(() => {});
            ...
            if(member){   
                ...
                return message.channel.send(embed.setDescription('<:check:990277303579836468> **<@'+member.user.id+'>**, İsimli üye başarıyla beyaliste\'den kaldırıldı.')).catch(() => {});}
            ...
            if(role) { 
                ...
                return message.channel.send(embed.setDescription('<:check:990277303579836468> **<@&'+role.id+'>**, İsimli rol başarıyla beyaliste\'den kaldırıldı.'));}
            ...
            if(channel) { 
                ...
                return message.channel.send(embed.setDescription('<:check:990277303579836468> **<#'+channel.id+'>**, İsimli kanal başarıyla beyaliste\'den kaldırıldı.')).catch(() => {});}
        }
    }
    if(command.toLowerCase() === 'filtre') {
        if(config.BotOwners.includes(message.member.id) === false && !message.member.hasPermission(8)) return message.channel.send(`<a:red:990277321414045767> Ayar komutlarını kullanabilmen için yönetici olman gerek.`);

        if (!args[0]) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: '+config.Prefix+'filtre ekle/kaldır kelime')).catch(() => {});
   
        if (args[0] === 'ekle' || args[0] === 'add' ) {
            if (!args[1]) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: '+config.Prefix+'filtre ekle/kaldır kelime')).catch(() => {});
            const Database = await db.findOne({ ServerID: message.guild.id });    
            ...
            return message.channel.send(embed.setDescription('<:check:990277303579836468> **'+args[1]+'**, Başarıyla filtre\'ye eklendi.')).catch(() => {});
        }
        ...
        if (args[0] === 'kaldır' || args[0] === 'remove' ) {
            ...
            return message.channel.send(embed.setDescription('<:check:990277303579836468> **'+args[1]+'**, Başarıyla filtre\'den kaldırıldı.')).catch(() => {}); }
    }
    if(command.toLowerCase() === 'muterolü') {
        if(config.BotOwners.includes(message.member.id) === false && !message.member.hasPermission(8)) return message.channel.send(`<a:red:990277321414045767> Ayar komutlarını kullanabilmen için yönetici olman gerek.`);

        let MuteRole = message.mentions.roles.first() || message.guild.roles.cache.get(args[0]);
        if(!MuteRole) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: **'+config.Prefix+'muterolü @rol/rol id**')).catch(() => {});
        await db.findOneAndUpdate({ ServerID: message.guild.id }, { $set: { MutedRoleID: MuteRole.id } });
        return message.channel.send(embed.setDescription('<:check:990277303579836468> Başarıyla **<@&'+MuteRole+'>**, Rolü mute rolü olarak ayarlandı.')).catch(() => {});
    }
    if(command.toLowerCase() === 'logkanalı') {
        if(config.BotOwners.includes(message.member.id) === false && !message.member.hasPermission(8)) return message.channel.send(`<a:red:990277321414045767> Ayar komutlarını kullanabilmen için yönetici olman gerek.`);

        let LogChannell = message.mentions.channels.first() || message.guild.channels.cache.get(args[0]);
        if(!LogChannell) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: **'+config.Prefix+'logkanalı #kanal/kanal id**')).catch(() => {});
        await db.findOneAndUpdate({ ServerID: message.guild.id }, { $set: { PunishLogChannelID: LogChannell.id } });
        return message.channel.send(embed.setDescription('<:check:990277303579836468> Başarıyla **<#'+LogChannell+'>**, kanalı log kanalı olarak ayarlandı.')).catch(() => {});
    }
    if(command.toLowerCase() === 'mutesüre') {
        if(config.BotOwners.includes(message.member.id) === false && !message.member.hasPermission(8)) return message.channel.send(`<a:red:990277321414045767> Ayar komutlarını kullanabilmen için yönetici olman gerek.`);

        if(!args[0] ||args[0] < 1) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: **'+config.Prefix+'mutesüre 15 (Süreyi dakika cinsinden giriniz.)**')).catch(() => {});
        await db.findOneAndUpdate({ ServerID: message.guild.id }, { $set: { MuteDurationMinute: args[0] } });
        return message.channel.send(embed.setDescription('<:check:990277303579836468> Başarıyla mute süresi **'+args[0]+'**, dakika olarak ayarlandı.')).catch(() => {});
    }
    if(command.toLowerCase() === 'cezakaldır') {
        ...
        if(!member) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: **'+config.Prefix+'cezakaldır @user/user id**')).catch(() => {});
        ...
        if(Database.BlueListMembers.includes(member.user.id) === true) {
            ...
            return  message.channel.send(embed.setDescription('<:check:990277303579836468> **<@'+member.user.id+'>**, İsimli üye\'nin uyarısı başarıyla kaldırıldı.')).catch(() => {});
        }
        ...
        if(Database.BlackListMembers.includes(member.user.id) === true) {
            ...
            return message.channel.send(embed.setDescription('<:check:990277303579836468> **<@'+member.user.id+'>**, İsimli üye\'nin mutesi başarıyla kaldırıldı.')).catch(() => {});
        }
    ...
    if(command.toLowerCase() === 'karakterlimit') {
        ...
        if (!args[0]) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: '+config.Prefix+'karakterlimit aç/kapat.')).catch(() => {});
        const Database = await db.findOne({ServerID: message.guild.id});
        if(args[0] === 'aç') {
            ...
            return message.channel.send(embed.setDescription('<:check:990277303579836468> <@'+message.author.id+'>, **Karakter Limit** başarıyla açıldı.')).catch(() => {});
        }
        ...
        if(args[0] === 'kapat') {
            ...
            return message.channel.send(embed.setDescription('<:check:990277303579836468> <@'+message.author.id+'>, **Karakter Limit** başarıyla kapatıldı.')).catch(() => {}); 
        }
    ...
    if(command.toLowerCase() === 'davetkoruma') {
        ...
        if (!args[0]) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: '+config.Prefix+'davetkoruma aç/kapat.')).catch(() => {});
        ...
        if(args[0] === 'aç') {
            ...
            return message.channel.send(embed.setDescription('<:check:990277303579836468> <@'+message.author.id+'>, **Davet koruması** başarıyla açıldı.')).catch(() => {});
        }
        ...
        if(args[0] === 'kapat') {
            ...
            return message.channel.send(embed.setDescription('<:check:990277303579836468> <@'+message.author.id+'>, **Invite koruması** başarıyla kapatıldı.')).catch(() => {});
        }
    ...
    if(command.toLowerCase() === 'linkkoruma') {
        ...
        if (!args[0]) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: '+config.Prefix+'linkkoruma aç/kapat.')).catch(() => {});
        ...
        if(args[0] === 'aç') {
            ...
            return message.channel.send(embed.setDescription('<:check:990277303579836468> <@'+message.author.id+'>, **Link koruması** başarıyla açıldı.')).catch(() => {});
        }
        ...
        if(args[0] === 'kapat') {
            ...
            return message.channel.send(embed.setDescription('<:check:990277303579836468> <@'+message.author.id+'>, **Link koruması** başarıyla kapatıldı.')).catch(() => {});
        }
    ...
    if(command.toLowerCase() === 'çokluetiket') {
        ...
        if(args[0] === 'aç') {
            ...
            return message.channel.send(embed.setDescription('<:check:990277303579836468> <@'+message.author.id+'>, **Etiket koruması** başarıyla açıldı.')).catch(() => {});
        }
        ...
        if(args[0] === 'kapat') {
            ...
            return message.channel.send(embed.setDescription('<:check:990277303579836468> <@'+message.author.id+'>, **Etiket koruması** başarıyla kapatıldı.')).catch(() => {});   
        }
    ...
    if(command.toLowerCase() === 'küfürkoruma') {
        ...
        if (!args[0]) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: '+config.Prefix+'küfürkoruma aç/kapat.')).catch(() => {});
    ...
    if(command.toLowerCase() === 'spamkoruma') {
        ...
        if (!args[0]) return message.channel.send(embed.setDescription('<a:red:990277321414045767> Örnek kullanım: '+config.Prefix+'spamkoruma aç/kapat.')).catch(() => {});
