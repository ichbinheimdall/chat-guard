...
<:ok:909555365056753755> Mute rolünü ayarlamak için: \`${config.Prefix}muterole @role [etiket/id] \`
<:ok:909555365056753755> Mute süresini ayarlamak için: \`${config.Prefix}mutesüre 10 [Süreyi dakika cinsinden girin] \`
<:ok:909555365056753755> Log kanalını ayarlamak için: \`${config.Prefix}logchannel @channel [etiket/id\`

<:bosluk:909565384775065670> <a:ayar:909561268128591872> **Korumalar:**
<:ok:909555365056753755> Ceza kaldırmak için: \`${config.Prefix}cezakaldır @user [etiket/id] \`  
<:ok:909555365056753755> Uzun yazı engel için: \`${config.Prefix}characterlimit [aç/kapat] \`
<:ok:909555365056753755> Sunucu davet linki engel: \`${config.Prefix}inviteguard [aç/kapat] \`
<:ok:909555365056753755> Link engel için: \`${config.Prefix}linkguard [aç/kapat] \`
<:ok:909555365056753755> Çoklu etiket engel için: \`${config.Prefix}masspingguard [aç/kapat] \`
<:ok:909555365056753755> Küfür engel için: \`${config.Prefix}badwordguard [aç/kapat] \`
<:ok:909555365056753755> Spam engel için: \`${config.Prefix}spamguard [aç/kapat] \`
...
<a:hologram:907617268173783060> Bot top.gg üzerinden oy verip destek olmak için \`${config.Prefix}oy\` yazabilirsin. 
    ...
    if(command.toLowerCase() === 'whitelist') {
        ...
        if(!args[0]) return message.channel.send(embed.setDescription('<a:red:811921646507261963> Örnek kullanım: **'+config.Prefix+'whitelist ekle/kaldır id/etiket (rol/kanal/kullanıcı)**'));
        ...
        if (args[0] === 'ekle' || args[0] === 'add' ) {
            ...
            if(!member && !role && !channel) return message.channel.send(embed.setDescription('<a:red:811921646507261963> Örnek kullanım: **'+config.Prefix+'whitelist ekle/kaldır id/etiket (rol/kanal/kullanıcı)**')).catch(() => {});
            ...
            if(member){   
                ...
                return message.channel.send(embed.setDescription('checkknk31 **<@'+member.user.id+'>**, İsimli üye başarıyla whitelist\'e eklendi'));}
            ...
            if(role) { 
                ...
                return message.channel.send(embed.setDescription('checkknk31 **<@&'+role.id+'>**, İsimli rol başarıyla whitelist\'e eklendi'));}
            ...
            if(channel) { 
                ...
                return message.channel.send(embed.setDescription('checkknk31 **<#'+channel.id+'>**, İsimli kanal başarıyla whitelist\'e eklendi')).catch(() => {});}
        }
        if (args[0] === 'remove' || args[0] === 'kaldır' ) {
            ...
            if(member){   
                ...
                return message.channel.send(embed.setDescription('checkknk31 **<@'+member.user.id+'>**, İsimli üye başarıyla whitelist\'ten kaldırıldı.')).catch(() => {});}
            ...
            if(role) { 
                ...
                return message.channel.send(embed.setDescription('checkknk31 **<@&'+role.id+'>**, İsimli rol başarıyla whitelist\'ten kaldırıldı.'));}
            ...
            if(channel) { 
                ...
                return message.channel.send(embed.setDescription('checkknk31 **<#'+channel.id+'>**, İsimli kanal başarıyla whitelist\'ten kaldırıldı.')).catch(() => {});}
        }
    }
    ...
    if(command.toLowerCase() === 'filtre') {
        ...
        if (args[0] === 'ekle' || args[0] === 'add' ) {
            ...
            return message.channel.send(embed.setDescription('checkknk31 **'+args[1]+'**, Başarıyla filtre\'ye eklendi.')).catch(() => {});
        }
        ...
        if (args[0] === 'kaldır' || args[0] === 'remove' ) {
            ...
            return message.channel.send(embed.setDescription('checkknk31 **'+args[1]+'**, Başarıyla filtre\'den kaldırıldı.')).catch(() => {}); }
    }
    ...
    if(command.toLowerCase() === 'muterole') {
        ...
        return message.channel.send(embed.setDescription('checkknk31 Başarıyla **<@&'+MuteRole+'>**, Rolü mute rolü olarak ayarlandı.')).catch(() => {});
    }
    ...
    if(command.toLowerCase() === 'logchannel') {
        ...
        return message.channel.send(embed.setDescription('checkknk31 Başarıyla **<#'+LogChannell+'>**, kanalı log kanalı olarak ayarlandı.')).catch(() => {});
    }
    ...
    if(command.toLowerCase() === 'mutesüre') {
        ...
        return message.channel.send(embed.setDescription('checkknk31 Başarıyla mute süresi **'+args[0]+'**, dakika olarak ayarlandı.')).catch(() => {});
    }
    ...
    if(command.toLowerCase() === 'cezakaldır') {
        ...
        if(Database.BlueListMembers.includes(member.user.id) === true) {
            ...
            return  message.channel.send(embed.setDescription('checkknk31 **<@'+member.user.id+'>**, İsimli üye\'nin uyarısı başarıyla kaldırıldı.')).catch(() => {});
        }
        ...
        if(Database.BlackListMembers.includes(member.user.id) === true) {
            ...
            return message.channel.send(embed.setDescription('checkknk31 **<@'+member.user.id+'>**, İsimli üye\'nin mutesi başarıyla kaldırıldı.')).catch(() => {});
        }
    ...
    if(command.toLowerCase() === 'characterlimit') {
        ...
        if(args[0] === 'aç') {
            ...
            return message.channel.send(embed.setDescription('checkknk31 <@'+message.author.id+'>, **Karakter Limit** başarıyla açıldı.')).catch(() => {});
        }
        ...
        if(args[0] === 'kapat') {
            ...
            return message.channel.send(embed.setDescription('checkknk31 <@'+message.author.id+'>, **Karakter Limit** başarıyla kapatıldı.')).catch(() => {}); 
        }
    ...
    if(command.toLowerCase() === 'inviteguard') {
        ...
        if(args[0] === 'aç') {
            ...
            return message.channel.send(embed.setDescription('checkknk31 <@'+message.author.id+'>, **Invite koruması** başarıyla açıldı.')).catch(() => {});
        }
        ...
        if(args[0] === 'kapat') {
            ...
            return message.channel.send(embed.setDescription('checkknk31 <@'+message.author.id+'>, **Invite koruması** başarıyla kapatıldı.')).catch(() => {});
        }
    ...
    if(command.toLowerCase() === 'linkguard') {
        ...
        if(args[0] === 'aç') {
            ...
            return message.channel.send(embed.setDescription('checkknk31 <@'+message.author.id+'>, **Link koruması** başarıyla açıldı.')).catch(() => {});
        }
        ...
        if(args[0] === 'kapat') {
            ...
            return message.channel.send(embed.setDescription('checkknk31 <@'+message.author.id+'>, **Link koruması** başarıyla kapatıldı.')).catch(() => {});
        }
    ...
    if(command.toLowerCase() === 'masspingguard') {
        ...
        if(args[0] === 'aç') {
            ...
            return message.channel.send(embed.setDescription('checkknk31 <@'+message.author.id+'>, **Etiket koruması** başarıyla açıldı.')).catch(() => {});
        }
        ...
        if(args[0] === 'kapat') {
            ...
            return message.channel.send(embed.setDescription('checkknk31 <@'+message.author.id+'>, **Etiket koruması** başarıyla kapatıldı.')).catch(() => {});   
        }
